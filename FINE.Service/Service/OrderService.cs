...
namespace FINE.Service.Service
{
    ...
    public class OrderService : IOrderService
    {
        ...
        public async Task<string> GetHtml(Order genOrder)
        {
            try
            {
                ...
                {
                    var storeName = _unitOfWork.Repository<Store>().GetAll().FirstOrDefaultAsync(x => x.Id == order.StoreId).Result.StoreName;
                    ...
                    {
                        var product = _unitOfWork.Repository<ProductInMenu>().GetAll().FirstOrDefaultAsync(x => x.Id == orderDetail.ProductInMenuId).Result.Product;
                ...
                var room = _unitOfWork.Repository<Room>().GetAll().FirstOrDefaultAsync(x => x.Id == genOrder.RoomId).Result;
                content += $"<tr>\r\n                                                    <td class=\"esd-structure\" align=\"left\">\r\n         " +
                    $"                                               <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\r\n                     " +
                    $"                                       <tbody>\r\n                                                                <tr>\r\n       " +
                    $"                                                             <td width=\"558\" class=\"esd-container-frame\" align=\"center\" valign=\"top\">\r\n " +
        ...
        public async Task<bool> CreateMailMessage(Order order)
        {
            try
            {
                ...
                //QRCodeData qrCodeData = qrGenerator.CreateQrCode($"https://dev.fine-api.smjle.vn/api/order/orderStatus?orderId={order.Id}", QRCodeGenerator.ECCLevel.Q);
                ...
                //SmtpServer.Port = 587;
                SmtpServer.Credentials = new System.Net.NetworkCredential("fine.smjle@gmail.com", "zaQ@12345");
