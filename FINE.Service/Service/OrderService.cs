...
//        Task<BaseResponsePagingViewModel<GenOrderResponse>> GetOrderByCustomerId(string id, PagingRequest paging);
//        Task<BaseResponseViewModel<GenOrderResponse>> CreatePreOrder(string id, CreatePreOrderRequest request);
//        Task<BaseResponseViewModel<GenOrderResponse>> CreateOrder(string id, CreateGenOrderRequest request);
